...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl">支付方式</h2>
       <a href="HouTaiproduct_detail" class="fr top_rt_btn add_icon">添加支付方式</a>
      </div>
      <table class="table">
       <tr>
        <th>缩略图</th>
       ...
       <tr>
        <td class="center"><img src="../../static/upload/alipay.png" width="165" height="65"/></td>
        <td>支付宝</td>
       ...
       <tr>
        <td class="center"><img src="../../static/upload/tenpay.png" width="165" height="65"/></td>
        <td>财付通</td>
       ...
       <tr>
        <td class="center"><img src="../../static/upload/wechatpay.png" width="165" height="65"/></td>
        <td>微信支付</td>
