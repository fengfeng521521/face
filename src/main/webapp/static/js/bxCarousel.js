...
(function($){$.fn.bxCarousel=function(options){
	...
	var defaults={move:1,display_num:1,speed:500,margin:55,auto:true,auto_interval:3000,auto_dir:'next',auto_hover:true,next_text:'next',next_image:'',prev_text:'prev',prev_image:'',controls:true};
...
$this.parent('.bx_container').wrap('<div class="bx_wrap"></div>').css({'float':'left','position':'relative','width':1180,'overflow':'hidden','margin-left':0,'margin-right':0}).before(controls);
