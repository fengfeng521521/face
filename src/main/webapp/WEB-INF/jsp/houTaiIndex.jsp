...
<header>
    ...
    <ul class="rt_nav">
        ...
        <li><a href="HouTailogin.html" class="quit_icon">安全退出</a></li>
    </ul>
</header>
<!--aside nav-->
<!--aside nav-->
<aside class="lt_aside_nav content mCustomScrollbar">
    <h2><a href="houTaiIndex.html">起始页</a></h2>
    <ul>
        <li>
            <dl>
                <dt>常用布局示例</dt>
                <!--当前链接则添加class:active-->
                <dd><a href="HouTaiproduct_list.html" class="active">商品列表示例</a></dd>
                <dd><a href="HouTaiproduct_detail.html">商品详情示例</a></dd>
                <dd><a href="HouTairecycle_bin.html">商品回收站示例</a></dd>
            </dl>
        </li>
        <li>
            <dl>
                <dt>订单信息</dt>
                <dd><a href="HouTaiorder_list.html">订单列表示例</a></dd>
                <dd><a href="HouTaiorder_detail.html">订单详情示例</a></dd>
            </dl>
        </li>
        <li>
            <dl>
                <dt>会员管理</dt>
                <dd><a href="HouTaiuser_list.html">会员列表示例</a></dd>
                <dd><a href="HouTaiuser_detail.html">添加会员（详情）示例</a></dd>
                <dd><a href="HouTaiuser_rank.html">会员等级示例</a></dd>
                <dd><a href="HouTaiadjust_funding.html">会员资金管理示例</a></dd>
            </dl>
        </li>
        <li>
            <dl>
                <dt>基础设置</dt>
                <dd><a href="HouTaisetting.html">站点基础设置示例</a></dd>
            </dl>
        </li>
        <li>
            <dl>
                <dt>配送与支付设置</dt>
                <dd><a href="HouTaiexpress_list.html">配送方式</a></dd>
                <dd><a href="HouTaipay_list.html">支付方式</a></dd>
            </dl>
        </li>
        <li>
            <dl>
                <dt>在线统计</dt>
                <dd><a href="HouTaidischarge_statistic.html">流量统计</a></dd>
                <dd><a href="HouTaisales_volume.html">销售额统计</a></dd>
            </dl>
        </li>
        <li>
